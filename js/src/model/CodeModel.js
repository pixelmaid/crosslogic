...
define(["jquery", "paper", "model/Script"],

	function($, paper, Script) {
		...
		class CodeModel {
			...
			parseInclude() {
				...
				this.scope.include = function(url) {};
				var self = this;
			...
			evaluateCode() {
				...
				var url =  this.script.name + "_" + this.getTimeStamp() + ".js";
				var code = this.preprocessCode(this.script.code, this.script.breakpoints);

				this.scope.execute(code, {
					url: url,
					source: this.script.code,
					sourceMaps: "inline"
				});
			}
